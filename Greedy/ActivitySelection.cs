...
class ActivitySelection
{
    ...
    {
        // f is already sorted, otherwise need to sort it and maintain s accordingly.
        int i = 0; // always zero index can be picked up for optimal solutoin
        Console.WriteLine(" " + i);
        for (int j = 1; j < s.Length; j++)
        {
            ...
            // making the greed choice for i suits because the finish time 
        }
